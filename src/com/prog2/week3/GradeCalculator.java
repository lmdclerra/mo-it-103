...
public class GradeCalculator extends JFrame {
    ...
    public GradeCalculator() {
        ...
        lblStudentName  = new JLabel("Student Name:");  txtStudentName = new JTextField(30);
        lblStudentNo    = new JLabel("Student No:");    txtStudentNo = new JTextField(30);
        lblQuiz1 = new JLabel("Quiz 1:");               txtQuiz1 = new JTextField(10);
        lblQuiz2 = new JLabel("Quiz 2:");               txtQuiz2 = new JTextField(10);
        lblQuiz3 = new JLabel("Quiz 3:");               txtQuiz3 = new JTextField(10);
        ...
        // Put constraint on components; Set label position: left
