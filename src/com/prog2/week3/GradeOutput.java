...
/* This code is a preparation to be use by GradeCalculator.java */
...
public class GradeOutput extends JFrame {
    ...
    // Constructor being used by GradeCalculator.java
    // This constructor will be called when the user clicks the Calculate button in GradeCalculator.java
    public GradeOutput(Student stud) {
        ...
        // Create the components // Create labels        
        ...
        panel.add(lblStudentName); panel.add(txtStudentName);
        panel.add(lblStudentNo);   panel.add(txtStudentNo);
        panel.add(lblQuiz1);       panel.add(txtQuiz1);
        panel.add(lblQuiz2);       panel.add(txtQuiz2);
        panel.add(lblQuiz3);       panel.add(txtQuiz3);
        panel.add(lblAveGrade);    panel.add(txtAveGrade);
        panel.add(closeButton);
        
        // Put constraint on components; Set label position: left based on the west of the panel
        ...
        layout.putConstraint(SpringLayout.WEST, txtAveGrade     ,  2, SpringLayout.EAST, lblAveGrade);
    ...
    public static void main(String[] args) {
        // Create a new Student object for testing
        Student testStudent = new Student();
        testStudent.setStudentName("John Doe");
        testStudent.setStudentNumber("12345678");
        testStudent.setQuiz1(85.0f);
        testStudent.setQuiz2(90.0f);
        testStudent.setQuiz3(95.0f);
        testStudent.computeAverage();
        
        // Create the GradeOutput frame
        GradeOutput frame = new GradeOutput(testStudent);        
